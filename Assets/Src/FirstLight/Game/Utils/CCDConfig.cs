...
namespace FirstLight.Game.Utils
{
	...
	public class CCDConfig
	{
		...
		/// </summary>
		[Preserve] public static string CCDBadgeName = FLEnvironment.Current.UCSEnvironmentName == FLEnvironment.DEVELOPMENT.Name ? "latest" : Application.version.Replace(".", "_");
