...
namespace FirstLight.UiService
{
	...
	public interface IUiAssetLoader
	{
		...
		/// </summary>
		UniTask<GameObject> InstantiatePrefabAsync(string path, Transform parent, bool instantiateInWorldSpace);
	...
	{
		/// <inheritdoc />
		public async UniTask<GameObject> InstantiatePrefabAsync(string path, Transform parent, bool instantiateInWorldSpace)
		{
