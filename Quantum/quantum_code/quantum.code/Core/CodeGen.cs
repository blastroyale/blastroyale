...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      public static System.Type GetEventType(Int32 eventID) {
        switch (eventID) {
          ...
          case EventOnHazardLanded.ID: return typeof(EventOnHazardLanded);
      ...
      public EventOnHazardLanded OnHazardLanded(Hazard HazardData, FPVector3 LandPosition) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventOnHazardLanded>(EventOnHazardLanded.ID);
  ...
  public unsafe partial class EventOnHazardLanded : EventBase {
    public new const Int32 ID = 10;
    public Hazard HazardData;
    public FPVector3 LandPosition;
    protected EventOnHazardLanded(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnHazardLanded() : 
