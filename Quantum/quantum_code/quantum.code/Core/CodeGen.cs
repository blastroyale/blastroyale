...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  [Quantum.AssetRefAttribute(typeof(QuantumBotDifficultyConfigs))]
  [System.SerializableAttribute()]
  public unsafe partial struct AssetRefQuantumBotDifficultyConfigs : IEquatable<AssetRefQuantumBotDifficultyConfigs>, IAssetRef<QuantumBotDifficultyConfigs> {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetGuid Id;
    ...
    public static implicit operator AssetRefQuantumBotDifficultyConfigs(QuantumBotDifficultyConfigs value) {
      var r = default(AssetRefQuantumBotDifficultyConfigs);
      if (value != null) {
        r.Id = value.Guid;
      }
      return r;
    ...
    public override Boolean Equals(Object obj) {
      return obj is AssetRefQuantumBotDifficultyConfigs other && Equals(other);
    }
    public Boolean Equals(AssetRefQuantumBotDifficultyConfigs other) {
      return Id.Equals(other.Id);
    }
    public static Boolean operator ==(AssetRefQuantumBotDifficultyConfigs a, AssetRefQuantumBotDifficultyConfigs b) {
      return a.Id == b.Id;
    }
    public static Boolean operator !=(AssetRefQuantumBotDifficultyConfigs a, AssetRefQuantumBotDifficultyConfigs b) {
      return a.Id != b.Id;
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (AssetRefQuantumBotDifficultyConfigs*)ptr;
        AssetGuid.Serialize(&p->Id, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial struct PlayerMatchData {
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize((Int32*)&p->Glider);
  ...
  public unsafe partial struct GameContainer : Quantum.IComponentSingleton {
    ...
    private fixed Byte _PlayersData_[4096];
    [FieldOffset(12)]
    public UInt32 TargetProgress;
    public FixedArray<PlayerMatchData> PlayersData {
      get {
        fixed (byte* p = _PlayersData_) { return new FixedArray<PlayerMatchData>(p, 128, 32); }
      }
    }
    public override Int32 GetHashCode() {
      unchecked { 
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct InsideVisibilityArea : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public EntityRef Area;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 577;
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (InsideVisibilityArea*)ptr;
        EntityRef.Serialize(&p->Area, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial struct Projectile : Quantum.IComponent {
    ...
    [FieldOffset(2)]
    public Byte KnockbackAmount;
    [FieldOffset(6)]
    public Int16 RangeSquared;
    [FieldOffset(8)]
    ...
    public Byte Speed;
    [FieldOffset(4)]
    public Byte StunDuration;
    [FieldOffset(24)]
    public EntityRef Target;
    [FieldOffset(5)]
    public Byte TeamSource;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 607;
        hash = hash * 31 + Attacker.GetHashCode();
        hash = hash * 31 + DamagePct.GetHashCode();
        hash = hash * 31 + DespawnTime.GetHashCode();
        hash = hash * 31 + Direction.GetHashCode();
        hash = hash * 31 + Iteration.GetHashCode();
        hash = hash * 31 + KnockbackAmount.GetHashCode();
        hash = hash * 31 + RangeSquared.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->DamagePct);
        serializer.Stream.Serialize(&p->Iteration);
        serializer.Stream.Serialize(&p->KnockbackAmount);
        serializer.Stream.Serialize(&p->Speed);
        serializer.Stream.Serialize(&p->StunDuration);
        serializer.Stream.Serialize(&p->TeamSource);
        serializer.Stream.Serialize(&p->RangeSquared);
        serializer.Stream.Serialize((Int32*)&p->SourceId);
        EntityRef.Serialize(&p->Attacker, serializer);
        EntityRef.Serialize(&p->Target, serializer);
        FP.Serialize(&p->DespawnTime, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct VisibilityArea : Quantum.IComponent {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [FramePrinter.PtrQListAttribute(typeof(EntityRef))]
    private Quantum.Ptr EntitiesInPtr;
    public QListPtr<EntityRef> EntitiesIn {
      get {
        return new QListPtr<EntityRef>(EntitiesInPtr);
      }
      set {
        EntitiesInPtr = value.Ptr;
      }
    }
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 677;
        hash = hash * 31 + EntitiesInPtr.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(Frame f, EntityRef entity) {
      EntitiesInPtr = default;
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (VisibilityArea*)ptr;
        QList.Serialize(p->EntitiesIn, &p->EntitiesInPtr, serializer, StaticDelegates.SerializeEntityRef);
    }
  }
  public unsafe partial class Frame {
    ...
    static partial void InitStaticGen() {
      ComponentTypeId.Setup(() => {
        ...
        ComponentTypeId.Add<Quantum.InsideVisibilityArea>(Quantum.InsideVisibilityArea.Serialize, null, null, ComponentFlags.None);
        ...
        ComponentTypeId.Add<Quantum.VisibilityArea>(Quantum.VisibilityArea.Serialize, null, Quantum.VisibilityArea.OnRemoved, ComponentFlags.None);
      });
    }
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.InsideVisibilityArea>();
      BuildSignalsArrayOnComponentRemoved<Quantum.InsideVisibilityArea>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.VisibilityArea>();
      BuildSignalsArrayOnComponentRemoved<Quantum.VisibilityArea>();
    }
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void SpecialUsed(EntityRef entity, Int32 specialIndex) {
        var array = _f._ISignalSpecialUsedSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.SpecialUsed(_f, entity, specialIndex);
          }
        }
      }
    ...
    public unsafe partial struct FrameEvents {
      ...
      public static System.Type GetEventType(Int32 eventID) {
        switch (eventID) {
          ...
          case EventOnEnterVisibilityArea.ID: return typeof(EventOnEnterVisibilityArea);
          case EventOnLeaveVisibilityArea.ID: return typeof(EventOnLeaveVisibilityArea);
          ...
          case EventOnProjectileFiredPredicted.ID: return typeof(EventOnProjectileFiredPredicted);
          ...
          case EventOnPlayerEnergyChanged.ID: return typeof(EventOnPlayerEnergyChanged);
      ...
      public EventOnEnterVisibilityArea OnEnterVisibilityArea(EntityRef Entity, EntityRef Area) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventOnEnterVisibilityArea>(EventOnEnterVisibilityArea.ID);
        ev.Entity = Entity;
        ev.Area = Area;
        _f.AddEvent(ev);
        return ev;
      }
      public EventOnLeaveVisibilityArea OnLeaveVisibilityArea(EntityRef Entity, EntityRef Area) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventOnLeaveVisibilityArea>(EventOnLeaveVisibilityArea.ID);
        ev.Entity = Entity;
        ev.Area = Area;
        _f.AddEvent(ev);
        return ev;
      ...
      public EventOnProjectileFiredPredicted OnProjectileFiredPredicted(EntityRef Projectile, Projectile ProjectileData) {
        var ev = _f.Context.AcquireEvent<EventOnProjectileFiredPredicted>(EventOnProjectileFiredPredicted.ID);
        ev.Projectile = Projectile;
        ev.ProjectileData = ProjectileData;
        _f.AddEvent(ev);
        return ev;
      ...
      public EventOnProjectileFailedHit OnProjectileFailedHit(Projectile Projectile, FPVector3 LastPosition) {
      ...
      public EventOnProjectileSuccessHit OnProjectileSuccessHit(Projectile Projectile, EntityRef HitEntity, FPVector3 HitPosition) {
      ...
      public EventOnPlayerLevelUp OnPlayerLevelUp(PlayerRef Player, EntityRef Entity, Int32 CurrentLevel) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventOnPlayerLevelUp>(EventOnPlayerLevelUp.ID);
        ev.Player = Player;
        ev.Entity = Entity;
      ...
      public EventOnPlayerEnergyChanged OnPlayerEnergyChanged(PlayerRef Player, EntityRef Entity, Int32 PreviousPowerValue, Int32 CurrentPowerValue, Int32 ChangeAmount, Int32 CurrentLevel) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventOnPlayerEnergyChanged>(EventOnPlayerEnergyChanged.ID);
        ev.Player = Player;
        ev.Entity = Entity;
      ...
      public EventOnPlayerAttack OnPlayerAttack(PlayerRef Player, EntityRef PlayerEntity, Equipment Weapon, QuantumWeaponConfig WeaponConfig, FPVector2 Direction, FP AttackRange) {
    ...
    public unsafe partial struct FrameAssets {
      ...
      public QuantumBotDifficultyConfigs QuantumBotDifficultyConfigs(AssetRefQuantumBotDifficultyConfigs assetRef) {
         return _f.FindAsset<QuantumBotDifficultyConfigs>(assetRef.Id);
      }
  ...
  public unsafe interface ISignalSpecialUsed : ISignal {
    void SpecialUsed(Frame f, EntityRef entity, Int32 specialIndex);
  }
  ...
  public unsafe partial class EventOnEnterVisibilityArea : EventBase {
    public new const Int32 ID = 3;
    public EntityRef Entity;
    public EntityRef Area;
    protected EventOnEnterVisibilityArea(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnEnterVisibilityArea() : 
  ...
  public unsafe partial class EventOnLeaveVisibilityArea : EventBase {
    public new const Int32 ID = 4;
    public EntityRef Entity;
    public EntityRef Area;
    protected EventOnLeaveVisibilityArea(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnLeaveVisibilityArea() : 
  ...
  public unsafe partial class EventOnProjectileFiredPredicted : EventBase {
    public new const Int32 ID = 18;
    public EntityRef Projectile;
    public Projectile ProjectileData;
    protected EventOnProjectileFiredPredicted(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnProjectileFiredPredicted() : 
  ...
  public unsafe partial class EventOnPlayerLevelUp : EventBase {
    public new const Int32 ID = 57;
    public PlayerRef Player;
    public EntityRef Entity;
    public Int32 CurrentLevel;
    protected EventOnPlayerLevelUp(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnPlayerLevelUp() : 
  ...
  public unsafe partial class EventOnPlayerEnergyChanged : EventBase {
    ...
    public Int32 CurrentLevel;
    protected EventOnPlayerEnergyChanged(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnPlayerEnergyChanged() : 
  ...
  public static unsafe partial class BitStreamExtensions {
    ...
    public static void Serialize(this IBitStream stream, ref AssetRefQuantumBotDifficultyConfigs value) {
      stream.Serialize(ref value.Id.Value);
    }
  ...
  [System.SerializableAttribute()]
  public unsafe partial class QuantumBotDifficultyConfigs : AssetObject {
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class ComponentPrototypeVisitor : Prototypes.ComponentPrototypeVisitorBase {
    ...
    public virtual void Visit(Prototypes.InsideVisibilityArea_Prototype prototype) {
      VisitFallback(prototype);
    }
    ...
    public virtual void Visit(Prototypes.VisibilityArea_Prototype prototype) {
      VisitFallback(prototype);
    }
  }
  ...
  public unsafe partial class TypeRegistry {
    partial void AddGenerated() {
      ...
      Register(typeof(Quantum.AssetRefQuantumBotDifficultyConfigs), Quantum.AssetRefQuantumBotDifficultyConfigs.SIZE);
      ...
      Register(typeof(Quantum.InsideVisibilityArea), Quantum.InsideVisibilityArea.SIZE);
      ...
      Register(typeof(Quantum.VisibilityArea), Quantum.VisibilityArea.SIZE);
  ...
  public unsafe partial class FramePrinterGen {
    public static void EnsureNotStripped() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.AssetRefQuantumBotDifficultyConfigs>();
...
namespace Quantum.Prototypes {
  ...
  public sealed unsafe partial class BotCharacter_Prototype : ComponentPrototype<BotCharacter> {
    ...
    public GameId_Prototype Glider;
    public FP DecisionInterval;
    public FP LookForTargetsToShootAtInterval;
    public FP NextDecisionTime;
    public FP NextLookForTargetsToShootAtTime;
    ...
    public FP SpecialAimingDeviation;
    public UInt32 LoadoutGearNumber;
    public EquipmentRarity_Prototype LoadoutRarity;
    public FP MaxAimingRange;
    public FP MovementSpeedMultiplier;
    public FP MaxDistanceToTeammateSquared;
    public QBoolean SpawnWithPlayer;
  ...
  [System.SerializableAttribute()]
  [Prototype(typeof(InsideVisibilityArea))]
  public sealed unsafe partial class InsideVisibilityArea_Prototype : ComponentPrototype<InsideVisibilityArea> {
    public MapEntityId Area;
    partial void MaterializeUser(Frame frame, ref InsideVisibilityArea result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
      InsideVisibilityArea component = default;
      Materialize((Frame)f, ref component, in context);
      return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref InsideVisibilityArea result, in PrototypeMaterializationContext context) {
      PrototypeValidator.FindMapEntity(this.Area, in context, out result.Area);
      MaterializeUser(frame, ref result, in context);
    }
    public override void Dispatch(ComponentPrototypeVisitorBase visitor) {
      ((ComponentPrototypeVisitor)visitor).Visit(this);
  ...
  [System.SerializableAttribute()]
  [Prototype(typeof(VisibilityArea))]
  public sealed unsafe partial class VisibilityArea_Prototype : ComponentPrototype<VisibilityArea> {
    [DynamicCollectionAttribute()]
    public MapEntityId[] EntitiesIn = {};
    partial void MaterializeUser(Frame frame, ref VisibilityArea result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
      VisibilityArea component = default;
      Materialize((Frame)f, ref component, in context);
      return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref VisibilityArea result, in PrototypeMaterializationContext context) {
      if (this.EntitiesIn.Length == 0) {
        result.EntitiesIn = default;
      } else {
        var list = frame.AllocateList(result.EntitiesIn, this.EntitiesIn.Length);
        for (int i = 0; i < this.EntitiesIn.Length; ++i) {
          EntityRef tmp = default;
          PrototypeValidator.FindMapEntity(this.EntitiesIn[i], in context, out tmp);
          list.Add(tmp);
        }
        result.EntitiesIn = list;
      }
      MaterializeUser(frame, ref result, in context);
    }
    public override void Dispatch(ComponentPrototypeVisitorBase visitor) {
  ...
  public unsafe partial class FlatEntityPrototypeContainer {
    ...
    [ArrayLength(0, 1)]
    public List<Prototypes.InsideVisibilityArea_Prototype> InsideVisibilityArea;
    [ArrayLength(0, 1)]
    ...
    [ArrayLength(0, 1)]
    public List<Prototypes.VisibilityArea_Prototype> VisibilityArea;
    partial void CollectGen(List<ComponentPrototype> target) {
      ...
      Collect(InsideVisibilityArea, target);
    ...
    public unsafe partial class StoreVisitor {
      ...
      public override void Visit(Prototypes.InsideVisibilityArea_Prototype prototype) {
        Storage.Store(prototype, ref Storage.InsideVisibilityArea);
      }
      ...
      public override void Visit(Prototypes.VisibilityArea_Prototype prototype) {
        Storage.Store(prototype, ref Storage.VisibilityArea);
      }
    }
  }
}
