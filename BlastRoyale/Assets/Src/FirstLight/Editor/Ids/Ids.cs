...
namespace FirstLight.Editor.Ids
{
	...
	internal class Ids
	{
		...
		internal static GameIdHolder GameIds = new ()
		{
			...
			{"PlayerSkinRaincoat", 341, PlayerSkin, Collection},
			{"PlayerSkinSakura", 342, PlayerSkin, Collection},
			{"PlayerSkinZombie", 343, PlayerSkin, Collection},
			...
			{"FlagBanana", 273, DeathMarker, Collection},
			{"FlagFire", 274, DeathMarker, Collection},
			{"FlagGG",  275, DeathMarker, Collection},
			{"FlagLaughing", 276, DeathMarker, Collection},
			{"FlagNoob", 277, DeathMarker, Collection},
			...
			{"MeleeSkinAxe", 224, MeleeSkin, Collection, BotItem},
			...
			{"MeleeSkinPickaxe", 243, MeleeSkin, Collection, BotItem},
