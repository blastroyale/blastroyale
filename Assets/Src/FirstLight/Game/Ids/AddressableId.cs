...
namespace FirstLight.Game.Ids
{
	...
	public static class AddressableConfigLookup
	{
			...
			{"GenerateIds", new List<AddressableConfig>
				{
					...
					new AddressableConfig(46, "Configs/AudioAdventureAssetConfigs.asset", "Assets/AddressableResources/Configs/AudioAdventureAssetConfigs.asset", typeof(FirstLight.Game.Configs.AssetConfigs.AudioAdventureAssetConfigs), new [] {"Quantum","GenerateIds"}),
					new AddressableConfig(47, "Configs/AdventureAssetConfigs.asset", "Assets/AddressableResources/Configs/AdventureAssetConfigs.asset", typeof(FirstLight.Game.Configs.AssetConfigs.AdventureAssetConfigs), new [] {"Quantum","GenerateIds"}),
					new AddressableConfig(48, "Configs/AdjectiveDataConfigs.asset", "Assets/AddressableResources/Configs/AdjectiveDataConfigs.asset", typeof(FirstLight.Game.Configs.AdjectiveDataConfigs), new [] {"Quantum","GenerateIds"}),
				}.AsReadOnly()}
		});
		...
		private static readonly IList<AddressableConfig> _addressableConfigs = new List<AddressableConfig>
		{
			...
			new AddressableConfig(14, "Configs/EquipmentMaterialStatsConfigs.asset", "Assets/AddressableResources/Configs/EquipmentMaterialStatsConfigs.asset", typeof(FirstLight.Game.Configs.EquipmentMaterialStatsConfigs), new [] {"Quantum","GenerateIds"}),
			...
			new AddressableConfig(16, "Configs/EquipmentStatsConfigs.asset", "Assets/AddressableResources/Configs/EquipmentStatsConfigs.asset", typeof(FirstLight.Game.Configs.EquipmentStatsConfigs), new [] {"Quantum","GenerateIds"}),
			...
			new AddressableConfig(39, "Configs/VfxConfigs.asset", "Assets/AddressableResources/Configs/VfxConfigs.asset", typeof(FirstLight.Game.Configs.AssetConfigs.VfxAssetConfigs), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(40, "Configs/VideoAssetConfigs.asset", "Assets/AddressableResources/Configs/VideoAssetConfigs.asset", typeof(FirstLight.Game.Configs.AssetConfigs.VideoAssetConfigs), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(41, "Configs/WeaponConfigs.asset", "Assets/AddressableResources/Configs/WeaponConfigs.asset", typeof(FirstLight.Game.Configs.WeaponConfigs), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(42, "Configs/Settings/AssetResources.asset", "Assets/AddressableResources/Configs/Settings/AssetResources.asset", typeof(Quantum.AssetResourceContainer), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(43, "Configs/Settings/Deterministic Config.asset", "Assets/AddressableResources/Configs/Settings/Deterministic Config.asset", typeof(DeterministicSessionConfigAsset), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(44, "Configs/Settings/PhotonServerSettings.asset", "Assets/AddressableResources/Configs/Settings/PhotonServerSettings.asset", typeof(PhotonServerSettings), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(45, "Configs/Settings/QuantumRunnerConfigs.asset", "Assets/AddressableResources/Configs/Settings/QuantumRunnerConfigs.asset", typeof(FirstLight.Game.Configs.QuantumRunnerConfigs), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(46, "Configs/Settings/SimulationConfig.asset", "Assets/AddressableResources/Configs/Settings/SimulationConfig.asset", typeof(SimulationConfigAsset), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(47, "Configs/Settings/UiConfigs.asset", "Assets/AddressableResources/Configs/Settings/UiConfigs.asset", typeof(FirstLight.UiService.UiConfigs), new [] {"Quantum","GenerateIds"}),
			new AddressableConfig(48, "Timeline/FtueTimeline.prefab", "Assets/AddressableResources/Timeline/FtueTimeline.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"})
		}.AsReadOnly();
	}
}
