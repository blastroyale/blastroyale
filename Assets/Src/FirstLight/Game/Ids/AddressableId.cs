			...
			{"GenerateIds", new List<AddressableConfig>
				{
					...
					new AddressableConfig(61, "Configs/AvatarCollectableConfigs.asset", "Assets/AddressableResources/Configs/AvatarCollectableConfigs.asset", typeof(FirstLight.Game.Configs.AvatarCollectableConfigs), new [] {"Quantum","GenerateIds"}),
