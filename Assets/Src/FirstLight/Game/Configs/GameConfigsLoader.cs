	...
	public class GameConfigsLoader : IConfigsLoader
	{
		...
		public IEnumerable<Task> LoadConfigTasks(IConfigsAdder configsAdder)
		{
			return new List<Task>
			{
				...
				LoadConfig<AudioWeaponConfigs>(AddressableId.Configs_AudioWeaponConfigs, asset => configsAdder.AddConfigs(data => (int)data.Id, asset.Configs)),
				...
				LoadConfig<EquipmentMaterialStatsConfigs>(AddressableId.Configs_EquipmentMaterialStatsConfigs, asset => configsAdder.AddSingletonConfig(asset)),
