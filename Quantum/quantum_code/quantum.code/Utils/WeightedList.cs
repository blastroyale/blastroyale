...
namespace Quantum
{
    ...
    public unsafe class WeightedList<T> : IEnumerable<T>
    {
        ...
        public void Add(ICollection<WeightItem<T>> listItems)
        {
            foreach (WeightItem<T> listItem in listItems)
            {
        ...
        private int FixWeight(int weight) => FixWeightSetToOne(weight);
    }
    ...
    public readonly struct WeightItem<T>
    {
