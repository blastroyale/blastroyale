...
{
	public class LocalizedRadioButtonGroup: RadioButtonGroup
	{
		protected string localizationKey { get; set; }
		
		public LocalizedRadioButtonGroup() : this(string.Empty)
		{
		}

		public LocalizedRadioButtonGroup(string key)
		{
			Localize(key);
		}
		...
		public new class UxmlFactory : UxmlFactory<LocalizedRadioButtonGroup, UxmlTraits>
		{
		}
		...
		public new class UxmlTraits : RadioButtonGroup.UxmlTraits
		{
			...
			{
				base.Init(ve, bag, cc);
				((LocalizedRadioButtonGroup) ve).Localize(_localizationKeyAttribute.GetValueFromBag(bag, cc));
			}
		}
	}
