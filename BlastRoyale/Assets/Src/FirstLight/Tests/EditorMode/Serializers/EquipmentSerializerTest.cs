	...
	public class EquipmentSerializerTest
	{
      ...
      ""Tuning"": 672
		...
		public void OldEquipmentDataToNew() {
			...
			var newRawJson =
				"{\"Inventory\":{\"1\":[1,\"ApoSMG\",0,0,0,4,0,0,1],\"2\":[1,\"SoldierHelmet\",0,0,1,4,0,0,1],\"3\":[1,\"ApoSMG\",0,0,0,4,0,0,1],\"4\":[1,\"SoldierHelmet\",0,0,1,4,0,0,1],\"5\":[1,\"TikTokAmulet\",0,0,0,4,0,0,1],\"6\":[1,\"WarriorArmor\",0,0,0,4,0,0,1]},\"NftInventory\":{}}";
