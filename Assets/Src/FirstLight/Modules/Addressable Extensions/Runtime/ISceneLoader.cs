...
namespace FirstLight.AddressablesExtensions
{
	...
	public interface ISceneLoader
	{
		...
		/// </summary>
		UniTask<Scene> LoadSceneAsync(string path, LoadSceneMode loadMode = LoadSceneMode.Single, bool activateOnLoad = true);
		...
		/// This method can be controlled in an async method and returns the asset loaded
		/// </summary>
		UniTask<Scene> LoadSceneAsync(AssetReferenceScene reference, LoadSceneMode loadMode = LoadSceneMode.Single, bool activateOnLoad = true);
