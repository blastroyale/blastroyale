...
namespace FirstLight.Editor.Ids
{
	...
	internal class Ids
	{
		...
		internal static GameIdHolder GameIds = new ()
		{
			...
			{"ApoShotgun", 71, Weapon, Equipment},
			...
			{"ApoMinigun", 87, Weapon, Equipment, Deprecated},
			{"ModPistol", 88, Weapon, Equipment, Simple},
			{"ModShotgun", 90, Weapon, Equipment, Deprecated},
			{"ModMachineGun", 91, Weapon, Equipment, Deprecated},
			{"ModRifle", 92, Weapon, Equipment, Deprecated},
			{"ModSniper", 93, Weapon, Equipment},
			{"ModLauncher", 94, Weapon, Equipment, Deprecated},
			{"ModHeavyMachineGun", 95, Weapon, Equipment},
			...
			{"SciCannon", 101, Weapon, Equipment, Simple},
