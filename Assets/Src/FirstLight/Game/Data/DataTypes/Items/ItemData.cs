...
namespace FirstLight.Game.Data.DataTypes
{
	...
	{
		None, Equipment, Unlock, Currency, Collection
	}
	...
	public class ItemData : IEquatable<ItemData>, IEqualityComparer<ItemData>
	{
		...
		[IgnoreDataMember]
		public ItemMetadataType MetadataType => _metadata?.MetaType ?? ItemMetadataType.None; 

		public ItemData() { } // should not be used except serialization
