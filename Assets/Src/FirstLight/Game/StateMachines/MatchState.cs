...
namespace FirstLight.Game.StateMachines
{
	...
	public class MatchState
	{
		...
		private async Task LoadMatchAssets()
		{
			...
			_assetAdderService.AddConfigs(_services.ConfigsProvider.GetConfig<EquipmentCollectableEffectsAssetConfigs>());
		...
		private async Task UnloadAllMatchAssets()
		{
			...
			_services.AssetResolverService.UnloadAssets(true, configProvider.GetConfig<EquipmentCollectableEffectsAssetConfigs>());
