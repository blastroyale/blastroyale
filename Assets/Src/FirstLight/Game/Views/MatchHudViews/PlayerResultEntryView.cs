...
namespace FirstLight.Game.Views.MatchHudViews
{
	...
	public class PlayerResultEntryView : MonoBehaviour
	{
		...
		[FormerlySerializedAs("_xpText")] [SerializeField, Required] private TextMeshProUGUI _trophiesText;
		...
		public void SetInfo(QuantumPlayerMatchData data, bool showExtra = true)
		{
			...
			_trophiesText.enabled = showExtra;
			_trophiesText.text = data.Data.PlayerTrophies.ToString();
