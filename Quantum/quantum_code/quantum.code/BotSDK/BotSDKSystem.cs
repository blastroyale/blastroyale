...
namespace Quantum
{
                                                        ...
                                                        ISignalOnComponentRemoved<AIBlackboardComponent>
  {
    ...
    public void OnAdded(Frame f, EntityRef entity, UTAgent* component)
    {
      UTManager.Init(f, &component->UtilityReasoner, component->UtilityReasoner.UTRoot, entity);
    }

    public void OnRemoved(Frame f, EntityRef entity, UTAgent* component)
    {
      component->UtilityReasoner.Free(f);
    }
