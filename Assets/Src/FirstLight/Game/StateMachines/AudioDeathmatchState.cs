...
namespace FirstLight.Game.StateMachines
{
	...
	public class AudioDeathmatchState
	{
		...
		public AudioDeathmatchState(IGameServices services, IGameDataProvider gameLogic, Action<IStatechartEvent> statechartTrigger)
		{
			_services = services;
		...
		public void Setup(IStateFactory stateFactory)
		{
			...
			lowIntensity.OnEnter(PlayDeathmatchLoop);
			
			final.OnEnter(UnsubscribeEvents);
		}

		private void PlayDeathmatchLoop()
		{
