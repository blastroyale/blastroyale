...
namespace Quantum {
  ...
  public unsafe partial class Frame {
    ...
    public unsafe partial struct FrameEvents {
      public const Int32 EVENT_TYPE_COUNT = 71;
      ...
      public static System.Type GetEventType(Int32 eventID) {
        switch (eventID) {
          ...
          case EventOnAudioExplosion.ID: return typeof(EventOnAudioExplosion);
      ...
      public EventOnChestOpened OnChestOpened(GameId ChestType, FPVector3 ChestPosition) {
        if (_f.IsPredicted) return null;
      ...
      public EventOnPlayerDamaged OnPlayerDamaged(PlayerRef Player, EntityRef Entity, EntityRef Attacker, UInt32 ShieldDamage, UInt32 PreviousShield, UInt32 CurrentShield, UInt32 HealthDamage, UInt32 TotalDamage, Int32 MaxHealth, Int32 ShieldCapacity, FPVector3 HitPosition) {
        if (_f.IsPredicted) return null;
      ...
      public EventOnAudioExplosion OnAudioExplosion(GameId SourceId, FPVector3 LandPosition) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventOnAudioExplosion>(EventOnAudioExplosion.ID);
        ev.SourceId = SourceId;
        ev.LandPosition = LandPosition;
        _f.AddEvent(ev);
        return ev;
      }
    }
  ...
  public unsafe partial class EventOnPlayerDamaged : EventBase {
    ...
    public UInt32 PreviousShield;
    public UInt32 CurrentShield;
  ...
  public unsafe partial class EventOnAudioExplosion : EventBase {
    public new const Int32 ID = 70;
    public GameId SourceId;
    public FPVector3 LandPosition;
    protected EventOnAudioExplosion(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnAudioExplosion() : 
    ...
    public override Int32 GetHashCode() {
      unchecked {
        ...
        hash = hash * 31 + LandPosition.GetHashCode();
        return hash;
      }
    }
  }
